...
// TOUTES les 45 actions du plan d'orientation de Lina - Structure JSON fournie
const allActions = [
  // ÉTAPE 0 - PRÉPARATION (5 tâches)
  ...
  // ÉTAPE 5 - FINALISATION (4 tâches) - DEADLINES CRITIQUES!
...
try {
  console.log('Ajout de TOUTES les 45 actions du plan d\'orientation de Lina...');
  ...
  console.log(`   - Phase 0 (PRÉPARATION): 5 tâches`);
  console.log(`   - Phase 1 (DÉCOUVERTE): 13 tâches`);
  console.log(`   - Phase 2 (PARCOURSUP): 9 tâches`);
  console.log(`   - Phase 3 (DOSSIERS): 5 tâches`);
  console.log(`   - Phase 4 (SUIVI): 3 tâches`);
  console.log(`   - Phase 5 (FINALISATION): 4 tâches`);
  console.log(`   - Phase 6 (RÉSULTATS): 4 tâches`);
  console.log(`   - Phase 7 (INSCRIPTION): 2 tâches`);
} catch (error) {
